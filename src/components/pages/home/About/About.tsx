...
const About = () => {
  return (
    <section
      id='about-section'
      className='flex flex-col justify-center items-center relative mb-37.5'
    >
      <Cloud fileName='about.svg' className='left-0' />

      <FadeUpMotion delay={0} x={0} y={50}>
        <SectionHeader>What is QuCore Dynamic?</SectionHeader>
      </FadeUpMotion>

      <div className='About_content flex justify-center items-center gap-12.5 mt-25'>
